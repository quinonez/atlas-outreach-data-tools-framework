...
class TTbarAnalysis(Analysis.Analysis):
  ...
  def analyze(self):
      ...
      if not ((leadlepton.tlv() + etmiss.tlv()).Mt() > 30.0): return False
      ...
      self.hist_leptptc.Fill(leadlepton.isoptcone30(), weight)
      self.hist_leptetc.Fill(leadlepton.isoetcone20(), weight)
